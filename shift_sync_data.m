...
%         pos_sound = find(difference_it_sound < mean_freq*3 & difference_it_sound > 0);
%         neg_sound = find(difference_it_sound > -mean_freq*5 & difference_it_sound < 0);
